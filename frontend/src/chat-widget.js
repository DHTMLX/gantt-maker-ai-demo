...
If this is something you'd like to see, please open an issue on GitHub: [https://github.com/DHTMLX/gantt-maker-ai-demo/issues](https://github.com/DHTMLX/gantt-maker-ai-demo/issues)
`);
        }
        if (cmd && cmd !== 'none') {
